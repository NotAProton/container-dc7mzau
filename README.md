...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dc7mzau.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dc7mzau.containers.anotherwebservice.com/
...
```
git clone git@github.com:NotAProton/container-dc7mzau.git
cd container-dc7mzau
```
...
```
docker attach container-dc7mzau
```
